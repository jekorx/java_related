...
<!-- DwrResponse为类名，与dwr.xml中javascript="DwrPush"对应 -->
<script type="text/javascript" src="dwr/dwrjs/interface/dwr_login_push.js"></script>
...
$(function() {
	...
	dwr_login_push.onPageLoad('${sessionScope.sessionid }');
	$("#submit").click(function() {
		dwr_login_push.msg($("#user").val(), $("#text").val());
		$("#text").val("");
	});
});
